...
void    SRes::initiateSpritesPath() {
    ...
    this->path[MANA_DISEASE] = "mana_disease.png";
    this->path[MANA_STOMPERS] = "mana_stompers.png";
    this->path[MOBBIN_GOBLIN] = "mobbin_goblin.png";
    this->path[MORTAR_MOLE] = "mortar_mole.png";
    this->path[PROTECTION_WARD] = "protection_ward.png";
    this->path[RECYCLED_RAINBOW] = "recycled_rainbow.png";
    this->path[ROCK_SLASHER] = "rock_slasher.png";
    this->path[RUBY_WAND] = "ruby_wand.png";
    this->path[SHEEPISH_RABBIT] = "sheepish_rabbit.png";
    this->path[STONE_GIANT] = "stone_giant.png";
    this->path[STRIP_MINING] = "strip_mining.png";
    this->path[MAGIC_MINERS] = "magic_miners.png";
